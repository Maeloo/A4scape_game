...
static public class DialogueData
{
    ...
    static private AnswerWrapper A_Landlord_1_No = new AnswerWrapper("No!", "B", "CloseDialogue");
    ...
    static public DialogueWrapper Landlord_2_b = new DialogueWrapper("Get   rid   of   5   of   them   and   come   back   to   me   once   done.", new AnswerWrapper[] { A_Landlord_2, EmptyAnswer }, true, false, false);
    ...
    static public DialogueWrapper Drunkard_1_c = new DialogueWrapper("Those   flying   rats   hate   cans.   AhahAhahHahAh!   Burrrrppp...", new AnswerWrapper[] { A_Drunkard_1, EmptyAnswer }, true, false, false);

    static private AnswerWrapper A_Landlord_3_PMT = new AnswerWrapper("Póg   mo   thóin!", "A", "A_Landlord_3_PMT");
    ...
    static public DialogueWrapper Landlord_3_e = new DialogueWrapper("Now   get   away   from   here   and   go   play   with   your   four   legged   friends!", new AnswerWrapper[] { A_Landlord_3_PMT, EmptyAnswer }, true, false, false);

    static private AnswerWrapper A_Doggo_1_Yes = new AnswerWrapper("Why   not!", "A", "A_Doggo_1_Yes");
    static private AnswerWrapper A_Doggo_1_No = new AnswerWrapper("I'll   pass.", "B", "CloseDialogue");
    ...
    static public DialogueWrapper Doggo_3_d = new DialogueWrapper("Wanna   see   what   the   future   will   be   like   because   of   such   behaviour?   ", new AnswerWrapper[] { A_Doggo_1_Yes, A_Doggo_1_No }, true, true, false);
    ...
    static public DialogueWrapper DoggoFutur_3_g = new DialogueWrapper("Everyone   deserves   to   write   their   OWN   and   UNIQUE   story.", EmptyAnswers, false, false, true);
