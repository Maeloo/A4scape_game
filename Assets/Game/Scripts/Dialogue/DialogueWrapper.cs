...
public struct AnswerWrapper
{
    ...
    public AnswerWrapper(string AT, KeyCode AI, string AC)
    {
        AnswerText = AT;
        AnswerInput = AI;
        AnswerCallback = AC;
...
static public class DialogueData
{
    ...
    static private AnswerWrapper EmptyAnswer = new AnswerWrapper("", KeyCode.None, "");
    static private AnswerWrapper[] EmptyAnswers = new AnswerWrapper[] { EmptyAnswer, EmptyAnswer };

    static private AnswerWrapper A_Landlord_1_Yes = new AnswerWrapper("Yes", KeyCode.Return, "A_Landlord_1_Yes");
    static private AnswerWrapper A_Landlord_1_No = new AnswerWrapper("No", KeyCode.Escape, "A_Landlord_1_No");
    ...
    static private AnswerWrapper A_Drunkard_1 = new AnswerWrapper("Thank you!", KeyCode.Return, "A_Drunkard_1");
    ...
    static private AnswerWrapper A_Landlord_3 = new AnswerWrapper("[Hmmm]", KeyCode.Return, "A_Landlord_3");
    ...
    static private AnswerWrapper A_Doggo_1_Yes = new AnswerWrapper("Yes", KeyCode.Return, "A_Doggo_1_Yes");
    static private AnswerWrapper A_Doggo_1_No = new AnswerWrapper("No", KeyCode.Escape, "A_Doggo_1_No");
